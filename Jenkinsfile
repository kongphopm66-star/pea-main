pipeline {
    ...
    parameters {
        ...
        string(
            name: 'API_HOST',
            // หมายเหตุ: ถ้า Jenkins รันบน VM/Cloud ต้องเปลี่ยน localhost เป็น IP ของเครื่องนั้น
...
EOF
                    ...
                    echo "Environment configuration createdd"
                }
            }
        }
            ...
            steps {
                script {
                    ...
                    sh """
                        ...
                        # ✅ แก้จาก /attractions เป็น /places ตาม API ของเรา
                        curl -f http://localhost:3001/places || exit 1
